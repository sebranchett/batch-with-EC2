...
class BatchEC2Stack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        # This resource alone will create a private/public subnet in each AZ
        # as well as nat/internet gateway(s)
        ...
        for i in range(count):
            ...
            batch_ce.append(batch.JobQueueComputeEnvironment(
